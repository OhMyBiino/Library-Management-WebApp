    ...
    public partial class TransactionHistory : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryManagementUser", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_LibraryManagementUser_UserID",
                        column: x => x.UserID,
                        principalTable: "LibraryManagementUser",
                        principalColumn: "Id",
